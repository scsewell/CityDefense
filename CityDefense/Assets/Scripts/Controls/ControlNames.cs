    ...
    public class ControlNames
    {
        public static string GetName(GameButton button)
        {
            switch (button)
            {
                ...
                case GameButton.Fire1:      return "Primary Fire";
                case GameButton.Fire2:      return "Alt Fire 1";
                case GameButton.Fire3:      return "Alt Fire 2";
            }
        ...
        public static string GetName(GameAxis axis)
        {
            switch (axis)
            {
                case GameAxis.TrackX:       return "Cursor Horizontal";
                case GameAxis.TrackY:       return "Cursor Vertical";
            }
